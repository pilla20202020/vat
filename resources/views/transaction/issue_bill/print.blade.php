        ...
        <div class="col-md-12 col-lg-10 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-5">
                        <div class="col-lg-6 ">
                            <h6>Billed To: {{$issuebill->bill_to}}</h6>
                            <h6>Invoice: {{$issuebill->draftbill->billingadvice->joborder->invoice}}</h6>
                        </div>

                        <div class="col-lg-6 text-right">
                            <h6>Address: {{$issuebill->address}}</h6>
                            <h6>Draft Bill Date: {{$issuebill->issue_bill_date}}</h6>
                        </div>
                    </div>
                    ...
                    <div class="row mt-1 p-4 text-center">
                        <table class="table">
                            ...
                            <tbody>
                                @if(isset($issuebill->issueDetails) && $issuebill->issueDetails->isEmpty() == false)
                                    @foreach ($issuebill->issueDetails as $key => $detail)
                                        <tr>
                                            <th scope="row">{{++$key}}</th>
                                            <td>
