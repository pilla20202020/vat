            ...
            <div class="card-underline">
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            {{-- <div class="form-group">
                                <input type="text" name="name" class="form-control" required
                                       value="{{ old('name', isset($vendor->name) ? $vendor->name : '') }}"/>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <input class="form-control" type="text" required name="name" value="{{ old('name', isset($vendor->name) ? $vendor->name : '') }}" placeholder="Enter Your Vendors Name">
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <div class="">
                                    ...
                                    value="{{ old('email', isset($vendor->email) ? $vendor->email : '') }}" placeholder="Enter a email" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <div class="">
                                    ...
                                    value="{{ old('phone', isset($vendor->phone) ? $vendor->phone : '') }}" placeholder="Enter a Phone" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <div class="">
                                    ...
                                    value="{{ old('address', isset($vendor->address) ? $vendor->address : '') }}" placeholder="Enter a Address" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-2 justify-content-center">
                        <div class="form-group">
                            <div>
                                <a class="btn btn-light waves-effect ml-1" href="{{ route('vendors.index') }}">
