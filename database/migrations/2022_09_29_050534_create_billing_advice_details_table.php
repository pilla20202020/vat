...
class CreateBillingAdviceDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_billing_advice_details', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('billingadvice_id')->unsigned()->index()->nullable();
    ...
    {
        Schema::dropIfExists('tbl_billing_advice_details');
    }
}
