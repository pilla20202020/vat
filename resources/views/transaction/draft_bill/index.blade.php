...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="d-flex">
                <header class="text-capitalize pt-1">Draft Bill List</header>
                <div class="tools ml-auto">
                    <a class="btn btn-primary ink-reaction" href="{{ route('draftbill.create') }}">
                        <i class="md md-add"></i>
                ...
                <div class="table-responsive">
                    <table id="example" class="table table-hover display">
                        ...
                        <tr>
                            ...
                            <th>Bill To</th>
                            <th>Address</th>
                            <th>Draft Billing Date</th>
                            <th>Actions</th>
                        </tr>
                        </thead>
                        <tbody>
                            @each('transaction.draft_bill.partials.table', $draftbills, 'draftbill')
                        </tbody>
