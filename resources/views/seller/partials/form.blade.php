            ...
            <div class="card-underline">
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            {{-- <div class="form-group">
                                <input type="text" name="name" class="form-control" required
                                       value="{{ old('name', isset($seller->name) ? $seller->name : '') }}"/>
                                <span id="textarea1-error" class="text-danger">{{ $errors->first('name') }}</span>
                                <label for="Name">Name</label>
                            </div> --}}

                            <div class="form-group ">
                                <label for="name" class="col-form-label pt-0">Seller Name</label>
                                <div class="">
                                    <input class="form-control" type="text" required name="name" value="{{ old('name', isset($seller->name) ? $seller->name : '') }}" placeholder="Enter Your sellers Name">
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <div class="">
                                    ...
                                    value="{{ old('email', isset($seller->email) ? $seller->email : '') }}" placeholder="Enter a email" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <div class="">
                                    ...
                                    value="{{ old('phone', isset($seller->phone) ? $seller->phone : '') }}" placeholder="Enter a Phone" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-2 justify-content-center">
                        <div class="form-group">
                            <div>
                                <a class="btn btn-light waves-effect ml-1" href="{{ route('seller.index') }}">
