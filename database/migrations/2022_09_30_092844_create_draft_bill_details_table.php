...
class CreateDraftBillDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_draft_bill_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_draft_bill_details');
    }
}
