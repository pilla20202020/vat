...
@section('title', 'Receive Bills List')

@section('content')
    <div class="row">
        <div class="col-12">
            <div class="d-flex">
                <header class="text-capitalize pt-1">Receive Bills List</header>
                <div class="tools ml-auto">
                    <a class="btn btn-primary ink-reaction" href="{{ route('receivebill.create') }}">
                        <i class="md md-add"></i>
                        Create Receive Bills
                    </a>
                </div>
            </div>
            <div class="card mt-2 p-4">
                <div class="table-responsive">
                    <table id="example" class="table table-hover display">
                        ...
                        <tbody>
                            @each('transaction.receive_bill.partials.table', $receivebills, 'receivebill')
                        </tbody>
